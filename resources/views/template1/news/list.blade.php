    ...
    <div class="group-mange-section">
        <div class="manage-tools">
            <ul>
                ...
                <li class="order-list"><a style="color:#000000" href="#" data-toggle="modal" data-target="#modal_full" onclick="sfi('กำลังโหลด...','/manage-admin/set_cat?m=news&id=<?php echo $r_cat_id ?>');">จัดการข้อมูล</a></li>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="sub-news">
                                            <div class="group-mange-section no-mg right-0">
                                                <div class="manage-tools">
                                                    <ul>
                                                        <li class="order-list"><a style="color: #000;" href="#" data-toggle="modal" data-target="#modal_full" onclick="sfi('กำลังโหลด...','/manage-admin/edit?m=news&id=<?php echo $r->id ?>');">แก้ไข</a></li> 
                                                        <li class="order-list"><a style="color: #000;" href="#" data-toggle="modal" data-target="#modal_full" onclick="sfi('กำลังโหลด...','/manage-admin/set_status_hide?m=news&id=<?php echo $r->id ?>');">ซ่อน</a></li>
                                                        <li class="order-list"><a style="color: #000;" href="#" data-toggle="modal" data-target="#modal_full" onclick="sfi('กำลังโหลด...','/manage-admin/delete?m=news&id=<?php echo $r->id ?>');">ลบ</a></li> 
                                                        <li class="order-list order-close">ปิด</li>
                                                    </ul>
                                                </div> 
                                                <div class="manage-edit">
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-6">
                                                    <div class="img-news" style="background-image: url('<?php if(strlen($r->img1) > 5){ echo $r->img1; }else{ echo base_url()."assets/logo_default.jpg"; } ?>');">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="content">
                                                        <div class="date">
                                                            <span class="color-primary">ข่าววันที่ : <?php echo date('j',$r->date_news)  ?> <?php echo $CustomHelper->date_unix_to_thai_mon($r->date_news) ?></span> <?php if($no_run == 1){ ?><img src="{{ asset('template1/assets/images/icons/icon-new.png')}}" alt="icon"><?php } ?>
                                                        </div>
                                                        <div class="desc-news">
                                                            <a href="<?php echo base_url() ?><?php echo $mod ?>/page/<?php echo $r_page_type ?>/<?php echo $r_page_id ?>/<?php echo $r_data_title ?>/<?php echo $r_data_this_page-1 ?>/info/<?php echo $r->id ?>/<?php echo $CustomHelper->remove_to_url($r->title,$r->en_title); ?>">
