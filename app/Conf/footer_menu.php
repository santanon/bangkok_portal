...
/*
URL PATH : /panels/footer_menu/
LOCATION : /application/controllers/panels/footer_menu.php
*/
 
class Footer_menu
{  
	var $mod = 'footer_menu'; 
	var $mod_model = 'Portal_website_footer_menu_page_model'; 
	var $mod_title = 'Footer Menu'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,4,3); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,4,3); btn2stageFocus(0,2);';        
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,4,3); btn2stageFocus(0,1);';   
			$data['config_dropdown_title'] = $this->lang->line($this->mod_cat_dropdown_title); 
