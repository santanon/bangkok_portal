...
/*
URL PATH : /panels/language/
LOCATION : /application/controllers/panels/language.php
*/
...
{  
	...
	var $config_list_footer_js = 'mainmenuFocus(1,1,3); btn2stageFocus(0,1);';
	...
	{ 
		...
		{  
			...
			$data['edit_lang_option'] = $row[0]->lang_option;
			$data['edit_lang_layout'] = $row[0]->lang_layout;
			$data['edit_lang_id'] = $row[0]->lang_id;
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,1,3); btn2stageFocus(0,1);';        
	...
	{ 
		...
		$d = new stdClass();  
		$d->lang_option = $this->input->post('lang_option', TRUE);
		$d->lang_layout = $this->input->post('lang_layout', TRUE);
		//$d->lang_id = $this->input->post('lang_id', TRUE);  
