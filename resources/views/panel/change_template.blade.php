                    ...
                    <div class="item-template" data-aos="zoom-in">
                        ...
                        <div class="action-btn">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="btn-manage">
                                        <a href="javascript:;" onclick="window.location = '/panel-admin/templatestep1_submit?no=1&re=1&id='+document.getElementById('slc_tp1').value;">
                    ...
                    <div class="item-template" data-aos="zoom-in">
                        ...
                        <div class="action-btn">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="btn-manage"> 
                                        <a href="javascript:;" onclick="window.location = '/panel-admin/templatestep1_submit?no=2&re=1&id='+document.getElementById('slc_tp2').value;">
                                            <button type="button" class="btn btn-blue">
                                            เลือกแบบนี้
                                        </button></a>
                                    </div>
                    ...
                    <div class="item-template" data-aos="zoom-in">
                        ...
                        <div class="action-btn">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="btn-manage"> 
                                        <a href="javascript:;" onclick="window.location = '/panel-admin/templatestep1_submit?no=3&re=1&id='+document.getElementById('slc_tp3').value;">
                                            <button type="button" class="btn btn-blue">
                                            เลือกแบบนี้
                                        </button></a>
                                    </div>
                    ...
                    <div class="item-template" data-aos="zoom-in">
                        ...
                        <div class="action-btn">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="btn-manage"> 
                                        <a href="javascript:;" onclick="window.location = '/panel-admin/templatestep1_submit?no=4&re=1&id='+document.getElementById('slc_tp4').value;">
                                            <button type="button" class="btn btn-blue">
                                            เลือกแบบนี้
                                        </button></a>
                                    </div>
                    ...
                    <div class="item-template" data-aos="zoom-in">
                        ...
                        <div class="action-btn">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="btn-manage"> 
                                        <a href="javascript:;" onclick="window.location = '/panel-admin/templatestep1_submit?no=5&re=1&id='+document.getElementById('slc_tp5').value;">
                                            <button type="button" class="btn btn-blue">
                                            เลือกแบบนี้
                                        </button></a>
                                    </div>
