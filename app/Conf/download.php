...
/*
URL PATH : /panels/download/
LOCATION : /application/controllers/panels/download.php
*/
 
class Download
{  
	var $mod = 'download'; 
	var $mod_model = 'Portal_website_download_model'; 
	var $mod_title = 'Download'; 
	
	var $mod_cat_mod = 'download_cat'; 
	var $mod_cat_model = 'Portal_website_download_cat_model'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,17,2); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,17,3); btn2stageFocus(0,2);';      
	...
	{ 
		...
		$d->file1 = $this->input->post('file1', TRUE);   
		$d->en_file1 = $this->input->post('en_file1', TRUE); 
