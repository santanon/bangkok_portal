...
/*
URL PATH : /panels/faq_cat/
LOCATION : /application/controllers/panels/faq_cat.php
*/
 
class Faq_cat
{  
	var $mod = 'faq_cat'; 
	var $mod_model = 'Portal_website_faq_cat_model'; 
	var $mod_title = 'FAQ Group'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_faq_model'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,15,1); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,15,1); btn2stageFocus(0,2);';        
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,15,1); btn2stageFocus(0,1);';        
