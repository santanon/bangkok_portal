                ...
                <div class="group-mange-section no-mg right-0">
                    ...
                    <a href="#" data-toggle="modal" data-target="#modal_full" onclick="sfi('LOGO','manage-admin/edit_logo?m=portal_website');">
                        <div class="manage-edit">
                            <img src="{{ asset('template5/assets/images/icons/icon-edit.svg')}}" alt="icon">
                        </div>
                    </a>
                </div>
                <div class="logo">
                ...
                @csrf <!-- {{ csrf_field() }} -->
                    ...
                    <div class="btn-search d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">
                            <img src="{{ asset('template5/assets/images/icons/icon-search-mobile.png')}}" alt="icon">
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="menu-main-wrapper">
        <ul class="sub-menu-main d-flex align-items-stretch">
            <li class="list icon-home">
                ...
                <path class="st0" d="M5.3,18.7v-7.2L12,5.3l6.7,6.3v7.2L5.3,18.7L5.3,18.7z"/>
                </svg>
                </a>
            </li>
            <li class="list open">
