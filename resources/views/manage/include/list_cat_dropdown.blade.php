...
{
	?>
    <span class="link-text" style="text-decoration:underline; font-size:12px;"><a href="<?php echo base_url().'panels/top_menu' ?>">&lt;&lt; <?php echo $TextLanguage->lang('back_to') ?> <?php echo $TextLanguage->lang('top_menu') ?></a></span><br />
    <?php
}
if(@$_SESSION[$config_mod.'_set_cat_footer_menu'] == '1')
{
	?>
    <span class="link-text" style="text-decoration:underline; font-size:12px;"><a href="<?php echo base_url().'panels/footer_menu' ?>">&lt;&lt; <?php echo $TextLanguage->lang('back_to') ?> <?php echo $TextLanguage->lang('footer_menu') ?></a></span><br />
    <?php
}
?>
<table align="center"> 
...
{
	?>
    <td valign="middle"><span class="header-text fontfacetext-bold"><a href="<?php echo base_url().'panels/' . $config_mod_cat_mod ?>" style="color:#004e6c"><?php echo $config_dropdown_title ?></a>   : &nbsp; </span></td>
