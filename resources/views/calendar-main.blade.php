...
<script src="{{ asset('template1/js/calendar3_9/lib/moment.min.js') }}"></script>
<script src="{{ asset('template1/js/calendar3_9/fullcalendar.min.js') }}"></script>
<script src="{{ asset('template1/js/calendar3_9/locale-all.js') }}"></script>
