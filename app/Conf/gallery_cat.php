...
/*
URL PATH : /panels/gallery_cat/
LOCATION : /application/controllers/panels/gallery_cat.php
*/
 
class Gallery_cat
{  
	var $mod = 'gallery_cat'; 
	var $mod_model = 'Portal_website_gallery_cat_model'; 
	var $mod_title = 'Gallery Group'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_gallery_model'; 
	var $mod_sub_field = 'cat_id'; 
	var $mod_sub_mod = 'gallery'; 
