    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <br><input onchange="document.getElementById('img1_preview').src = this.value" type="text" name="img1" id="img1" value="<?php echo $edit_img1 ?>" />
                </td>
            </tr>
