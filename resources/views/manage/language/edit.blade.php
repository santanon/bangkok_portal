    ...
    <table>
        <tbody>
            ...
            <div class="align-box" style="width:110px;"> 
                <input name="lang_option" type="radio" id="test-radio1" value="1" <?php if($edit_lang_option == '1'){ ?> checked="checked" <?php } ?>  onclick="show_link('1');"> 
                <label class="input-label" for="test-radio1"><?php echo $TextLanguage->lang('on'); ?></label>
            </div>&nbsp;&nbsp;
            <div class="align-box" style="width:110px;"> 
                    <input name="lang_option" type="radio" id="test-radio2" value="2" <?php if($edit_lang_option == '2'){ ?> checked="checked" <?php } ?> onclick="show_link('2');"  />
            ...
            <tr id="link_hide_1">
                ...
                <td>
            <div class="align-box" style="width:110px;"> 
                <input name="lang_layout" type="radio" id="test-radio3" value="1" <?php if($edit_lang_layout == '1'){ ?> checked="checked" <?php } ?> /> 
                <label class="input-label" for="test-radio3"><?php echo $TextLanguage->lang('top'); ?></label>
            </div>&nbsp;&nbsp;
            <div class="align-box" style="width:110px;"> 
                    <input name="lang_layout" type="radio" id="test-radio4" value="2" <?php if($edit_lang_layout == '2'){ ?> checked="checked" <?php } ?>  />
            ...
            <tr id="link_hide_2" style="visibility:hidden">
                ...
                <td>
           <div class="align-box" style="width:110px;"> 
                <input name="lang_id" type="radio" id="test-radio5" value="1" <?php if($edit_lang_id == '1'){ ?> checked="checked" <?php } ?> /> 
                <label class="input-label" for="test-radio5"><?php echo $TextLanguage->lang('flag'); ?></label>
            </div>&nbsp;&nbsp;
            <div class="align-box" style="width:110px;"> 
                    <input name="lang_id" type="radio" id="test-radio6" value="2" <?php if($edit_lang_id == '2'){ ?> checked="checked" <?php } ?>  />
