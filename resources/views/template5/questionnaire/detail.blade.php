                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">                                      
                                            <div class="text-content page-detail">
                                                ...
                                                <p>
                                                    ระหว่างวันที่ 30 ต.ค. - 5 ธ.ค. 2563 ณ สนามศูนย์เยาวชนกรุงเทพมหานคร 
                                                    (ไทย-ญี่ปุ่น) ดินแดง ชิงถ้วยเกียรติยศ พร้อมทุนการศึกษารวม 250,000 บาท
                                                </p>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-start match-height2">
                                                <div class="text-onbottom bg-color-secondary">
                                                    155คน ร่วมตอบคำถาม (25%)
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="topic-form">
                        ...
                        <div class="order-topic">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="input-custom">
                                        <input class="style-input" type="text" name="" placeholder="อุปกรณ์">
                                    </div>
                                </div>
                            </div>
                        </div>
