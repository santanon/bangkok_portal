        ...
        <div class="manage-add">
            <img src="{{ asset('template1/assets/images/icons/icon-add.svg')}}" alt="เพิ่ม">
                ...
                @csrf <!-- {{ csrf_field() }} -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-custom inp-categories">
                                                    <label for="" class="title-field">เรื่อง</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-custom">
                                                    <label for="" class="title-field">ข้อความ</label>
                            ...
                            <div class="btn-custom d-flex justify-content-center mx-auto">
                    ...
                    <div class="main-content -contact">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="top-content pt-4 border-top-primary">
                                            <div class="group-text">
                ...
                <div class="inner-content">
                    ...
                    <div class="main-content -contact">
                        <div class="list-item-gov">
                            <div class="title-gov d-flex align-items-center">เลขานุการสภากรุงเทพฯ</div>
                            ...
                            <div class="contact-gov">
                                <div class="tel-gov d-flex align-items-center">
                                    <div class="number">
                                        <span class="icon">
                                        ...
                                        <span class="text-tel">
                                            <a href="tel:022225349">0-2222-5349</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="contact-gov internal">
                                <div class="tel-gov d-flex justify-content-center align-items-center">
                                    <div class="number">
                                        <span class="text-tel">
                                            1120
                                        </span>
