<!-- อัลบั้มภาพ -->
<div id="album" data-id="album" class="section-content">
        ...
        <div class="inner-content">
            <div class="top-content">
                <div class="group-text">
                    <a href="/album" class="title">ภาพกิจกรรม</a>
                    <p class="desc">The Bangkok Metropolitan Council Secretariat </p>
                </div>
                <div class="group-gotoall">
                    <a href="/album" class="btn btn-outline-dark">ภาพกิจกรรมทั้งหมด</a>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="item album hilight">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-lg-6 col-md-6">
                                        <div id="dynamic1" href="javascript:void(0)" class="cover-album" style="background-image: url('../../template1/assets/images/img-album-demo1.png');">
                                            <div class="top-album">
                                                <div class="source">
                                                    <span>PR BKK</span>
                                                </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                            <div class="item album" >
                                ...
                                <div id="dynamic2" href="javascript:void(0)" class="cover-album" style="background-image: url('../../template1/assets/images/img-album-demo2.jpg');">
                                    <div class="top-album">
                                        <div class="source">
                                            <span>PR BKK</span>
                                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                            <div class="item album" >
                                ...
                                <div id="dynamic2" href="javascript:void(0)" class="cover-album" style="background-image: url('../../template1/assets/images/img-album-demo3.jpg');">
                                    <div class="top-album">
                                        <div class="source">
                                            <span>PR BKK</span>
                                        </div>
