        ...
        <div class="inner-content">
            ...
            <div class="main-content">
                <div class="gallery-template">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="item -album -list list-large">
                                        ...
                                        <div class="bg-layer">
                                            <div class="icon-search-hover">
                                                <div class="icon-search">
                                                    ...
                                                    <g>
                                                        <circle class="st0" cx="9.3" cy="9.3" r="7.3"></circle>
                                                        <line class="st0" x1="14.9" y1="14.9" x2="18" y2="18"></line>
                                                    </g>
                                                    </svg>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item -album -list" id="dynamic2">
                                <div class="group-mange-section no-mg right-0">
                                    <div class="manage-tools">
                                        <ul>
                                            <li class="order-list">จัดการ</li>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item -album -list" id="dynamic1">
                                <div class="group-mange-section no-mg right-0">
                                    <div class="manage-tools">
                                        <ul>
                                            <li class="order-list">จัดการ</li>
