...
{   
    ...
    <td align="left"> &nbsp; <?php if($row->title <> ''){echo $row->title;}else if($row->en_title <> ''){echo $row->en_title;}else{echo '-';} ?> [<?php echo date('d-m-Y',$row->date_news) ?> ถึง <?php echo date('d-m-Y',$row->date_news_end) ?>]
