...
$listbanner.on('init', function(event, slick){
  slideCount = slick.slideCount;
  setSlideCount();
  setCurrentSlideNumber(slick.currentSlide);
});

$listbanner.on('beforeChange', function(event, slick, currentSlide, nextSlide){
...
$(function () {
    ...
    const check_list_banner = $('.list-banner li').length;
    //console.log(check_list_banner);
    if(check_list_banner == 1){
      //alert('inside Page')
