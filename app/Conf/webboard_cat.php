...
/*
URL PATH : /panels/webboard_cat/
LOCATION : /application/controllers/panels/webboard_cat.php
*/
 
class Webboard_cat
{  
	var $mod = 'webboard_cat'; 
	var $mod_model = 'Portal_website_webboard_cat_model'; 
	var $mod_title = 'List Room'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_webboard_model'; 
	var $mod_sub_field = 'room_id'; 
	var $mod_sub_mod = 'webboard'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,12,1); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,12,2); btn2stageFocus(0,2);';        
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,12,1); btn2stageFocus(0,1);';        
