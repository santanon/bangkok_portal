<!-- คำถามที่พบบ่อย -->
<div id="faq" data-id="faq" class="section-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 order-lg-2">
                                            <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link mb-3 p-3 d-flex align-items-center active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">
                                                    ...
                                                    <span class="text-title">
                                                        เด็กอายุกี่ขวบต้องแจ้งการเข้าเรียนตามกฎหมายและใช้เอกสารอะไรบ้าง?
                                                    </span>
                                                </a>

                                                <a class="nav-link mb-3 p-3 d-flex align-items-center" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">
                                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="42.2px" height="42.2px" viewBox="0 0 42.2 42.2" style="enable-background:new 0 0 42.2 42.2;" xml:space="preserve">
                                                    <path class="st0" d="M5.1,21c0,8.6,6.9,15.5,15.4,16c5.7,0.4,11.4-1.3,16.5-3.9c-2.8-2.8-2.1-6.8-1.3-9.6c1.1-3.3,1.1-7-0.5-10.1
                                                        c-1.1-2.1-2.7-4-4.6-5.4c-0.7-0.6-2.4-1.4-2.4-1.4c-2.1-1-4.5-1.6-7-1.6c-9,0-16.2,7.3-16.2,16.2V21z"></path>
                                                    </svg>
                                                ...
                                                <a class="nav-link mb-3 p-3 d-flex align-items-center" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">
                                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="42.2px" height="42.2px" viewBox="0 0 42.2 42.2" style="enable-background:new 0 0 42.2 42.2;" xml:space="preserve">
                                                    <path class="st0" d="M5.1,21c0,8.6,6.9,15.5,15.4,16c5.7,0.4,11.4-1.3,16.5-3.9c-2.8-2.8-2.1-6.8-1.3-9.6c1.1-3.3,1.1-7-0.5-10.1
                                                        c-1.1-2.1-2.7-4-4.6-5.4c-0.7-0.6-2.4-1.4-2.4-1.4c-2.1-1-4.5-1.6-7-1.6c-9,0-16.2,7.3-16.2,16.2V21z"></path>
                                                    </svg>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
                                                    <div class="title mb-4 color-primary">เด็กอายุกี่ขวบต้องแจ้งการเข้าเรียนตามกฎหมายและใช้เอกสารอะไรบ้าง?</div>
                                                    <p class="desc mb-2">
                                                ...
                                                <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                                                    <h4 class="title mb-4 color-primary">Reviews</h4>
                                                    <p class="desc mb-2">
