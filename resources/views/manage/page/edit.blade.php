...
<input type="button" name="upload" value="<?php echo $TextLanguage->lang('file_manager'); ?>" onclick="callLightbox('<?php echo base_url(); ?>panel/fm/form/img1',1120,640);return false;" /><br />
  <?php echo $TextLanguage->lang('image_size_page_texteditor'); ?><br />                    
...
show_it('tr_<?php echo $edit_page_type ?>');
    ...
    <input type="hidden" name="this_cat_id" value="<?php echo $edit_cat_id ?>" />
    <input type="hidden" name="this_page_id" value="<?php echo $edit_page_id ?>" />
    </form>
