...
/*
URL PATH : /panels/poll_cat/
LOCATION : /application/controllers/panels/poll_cat.php
*/
 
class Poll_cat
{  
	var $mod = 'poll_cat'; 
	var $mod_model = 'Portal_website_poll_cat_model'; 
	var $mod_title = 'Poll Group'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_poll_model'; 
	var $mod_sub_field = 'cat_id'; 
	var $mod_sub_mod = 'poll'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,13,1); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,13,1); btn2stageFocus(0,2);';        
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,13,1); btn2stageFocus(0,1);';        
