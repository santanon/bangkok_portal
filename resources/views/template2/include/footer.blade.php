                ...
                <div class="group-footer left">
                    ...
                    <div class="group-content-footer">
                        ...
                        <div class="text-content">
                            173 ศาลาว่าการกรุงเทพมหานคร (เสาชิงช้า)<br> ถนนดินสอ แขวงเสาชิงช้า เขตพระนคร <br>กรุงเทพมหานคร 10200
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="social-wrapper d-flex align-items-center">
                                <!-- <div class="text-social">Social</div> -->
                                <ul>
                                    <li class="facebook">
