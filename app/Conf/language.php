...
{  
	...
	{   
		...
		$d = new \stdClass();  
		$d->lang_option = $CustomHelper->input_post('lang_option', TRUE);
		$d->lang_layout = $CustomHelper->input_post('lang_layout', TRUE);
		//$d->lang_id = $CustomHelper->input_post('lang_id', TRUE);  
		$this_qr = ''; 
