...
class Contactus_sub
{  
	var $mod = 'contactus_sub'; 
	var $mod_model = 'Portal_website_contactus_sub_model'; 
	var $mod_title = 'ติดต่อส่วนราชการ'; 
	...
	{   
		...
		$data['this_cat'] = "ติดต่อส่วนราชการ";
	...
	{   
		...
		$d->file1 = $CustomHelper->input_post('file1', FALSE);  
		$d->en_file1 = $CustomHelper->input_post('en_file1', FALSE);  
