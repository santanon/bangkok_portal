    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td>
                <input name="info" type="text" class="sm-input" id="info" style="width:40%" placeholder="0-2222-2222" maxlength="11">  
                </td>
            </tr> 
            <tr>
                <th width="120">เบอร์ต่อ (ภายใน)</th>
                <td>
                <input name="en_info" type="text" class="sm-input" id="info" style="width:40%" placeholder="1234" maxlength="11">  
                </td>
            </tr> 
            <tr>
                <th width="120">Facebook (URL)</th>
                <td>
                <input name="file1" type="text" class="sm-input" id="file1" style="width:40%" placeholder="http://www.facebook.com/xxxxx" maxlength="11">  
                </td>
            </tr> 
            <tr>
                <th width="120">Twitter (URL)</th>
                <td>
                <input name="en_file1" type="text" class="sm-input" id="en_file1" style="width:40%" placeholder="https://twitter.com/xxxxx" maxlength="11">  
                </td>
            </tr> 
