...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'URL'           => 'http://localhost/bangkok.go.th.portal/upload/user/'.sprintf('%08d', $_SESSION['panel_id']).'',// URL to files (REQUIRED)
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../../../upload/user_trash/'.sprintf('%08d', $_SESSION['panel_id']).'',
			'tmbURL'        => 'http://localhost/bangkok.go.th.portal/upload/user_trash/'.sprintf('%08d', $_SESSION['panel_id']).'',// URL to files (REQUIRED)
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
