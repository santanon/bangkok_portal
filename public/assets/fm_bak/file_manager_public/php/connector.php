...
$filename = '../../../upload/user_public/'.$_SESSION['panel_web_url'].'/';
...
{
    mkdir('../../../upload/user_public/'.$_SESSION['panel_web_url'].'/');
}  
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'URL'           => 'http://127.0.0.1:8000/manage-admin/upload/user_public', // URL to files (REQUIRED)
			'accessControl' => 'access',            // disable and hide dot starting files (OPTIONAL) 
			'attributes'   => array(
            array(
                'pattern' => '/.('.$str_lock.')/', // Dont write or delete to this and all subfolders
                'read'  => true,
                'write' => false,
                'locked' => true
                )   
