...
/*
URL PATH : /panels/download_cat/
LOCATION : /application/controllers/panels/download_cat.php
*/
 
class Download_cat
{  
	var $mod = 'download_cat'; 
	var $mod_model = 'Portal_website_download_cat_model'; 
	var $mod_title = 'Download Group'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_download_model'; 
	var $mod_sub_field = 'cat_id'; 
	var $mod_sub_mod = 'download'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,17,1); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,17,1); btn2stageFocus(0,2);';        
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,17,1); btn2stageFocus(0,1);';        
