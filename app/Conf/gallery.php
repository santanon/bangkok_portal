...
/*
URL PATH : /panels/gallery/
LOCATION : /application/controllers/panels/gallery.php
*/
 
class Gallery
{  
	var $mod = 'gallery'; 
	var $mod_model = 'Portal_website_gallery_model'; 
	var $mod_title = 'Gallery'; 
	
	var $mod_cat_mod = 'gallery_cat'; 
	var $mod_cat_model = 'Portal_website_gallery_cat_model'; 
	...
	{ 
		...
		$d->folder = $this->input->post('folder', TRUE);    
