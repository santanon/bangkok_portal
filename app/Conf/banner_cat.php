...
/*
URL PATH : /panels/banner_cat/
LOCATION : /application/controllers/panels/banner_cat.php
*/
 
class Banner_cat
{  
	var $mod = 'banner_cat'; 
	var $mod_model = 'Portal_website_banner_cat_model'; 
	var $mod_title = 'Banner Group'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_banner_model'; 
	var $mod_sub_field = 'cat_id'; 
	var $mod_sub_mod = 'banner'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,7,1); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,7,1); btn2stageFocus(0,2);';        
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,7,1); btn2stageFocus(0,1);';        
