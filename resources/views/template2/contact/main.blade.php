                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="contact-tel">
                                    <div class="icon-tel">
                                        <img src="{{ asset('template2/assets/images/icons/icon-tel.svg')}}" alt="icon"> 
                                    </div> 
                            ...
                            <div class="col-lg-6">
                                <div class="contact-tel">
                                    <div class="icon-tel">
                                    <img src="{{ asset('template2/assets/images/icons/icon-fax.svg')}}" alt="icon"> 
                                    </div> 
                        ...
                        <form>
                            <div class="group-form-section -contact">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="input-custom">
                                            <label for="" class="title-field">&nbsp;</label>
                                            <button class="btn btn-primary w-100" type="submit">ส่งข้อความ</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <hr class="border"></hr>
                ...
                <div class="inner-content">
                    ...
                    <div class="main-content -contact">
                        <div class="list-item-gov">
                            ...
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-secondary">
                                    ...
                                    <a href="tel: 0-2222-5349" class="number">0-2222-5349</a>
                                </div>
                            </div>
                            <div class="contact-gov internal">
                                <div class="tel-gov bg-color-primary">
                        ...
                        <div class="list-item-gov">
                            ...
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-secondary">
                                    ...
                                    <a href="tel:0-2226-2759" class="number">0-2226-2759</a>
                                </div>
                            </div>
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-primary">
                        ...
                        <div class="list-item-gov">
                            ...
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-secondary">
                                    ...
                                    <a href="0-2225-7093" class="number">0-2225-7093</a>
                                </div>
                            </div>
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-primary">
                        ...
                        <div class="list-item-gov">
                            ...
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-secondary">
                                    ...
                                    <a href="tel:0-2224-3006" class="number">0-2224-3006</a>
                                </div>
                            </div>
                            <div class="contact-gov">
                                <div class="tel-gov bg-color-primary">
                        ...
                        <div class="load-more text-right">
                            <a href="javascript: void(0)" class="btn btn-outline-dark">โหลดเพิ่มเติม</a>
                        </div>
                    </div>
                </div>
            </div>
