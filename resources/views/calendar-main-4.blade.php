...
<div class="main-wrapper">
    ...
    <div id="site-content">
        ...
        <div class="group-section-content">
            @include('template4/calendar.list')
        </div>
...
<script>
    $(document).ready(function(){
        ...
        const mm = String(monthNamesTh[today.getMonth()]); //January is 0!
        const yyyy = String(today.getFullYear() + 543);
        const curentMY = mm + ' / ' + yyyy;
        // console.log(curentMY);
        $('.date-title').html(dd);
        // $('.month-title').html(monthNamesTh[today.getMonth()]);
        // $('.year-title').html(yyyy);
        $('.current-title').html(curentMY);
    });
</script>
@endsection
