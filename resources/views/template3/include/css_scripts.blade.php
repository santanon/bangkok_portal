...
<!-- navgoco -->
<link rel="stylesheet" href="{{ asset('template3/theme-green/css/jquery.navgoco.css')}}">
...
<!-- Slick -->
<link rel="stylesheet" href="{{ asset('template3/theme-green/css/slick.css')}}">
<link rel="stylesheet" href="{{ asset('template3/theme-green/css/slick-theme.css')}}">
