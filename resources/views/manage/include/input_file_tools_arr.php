...
<iframe class="this_iframe" id="list_rec_<?php echo $this_name ?>" src="/upload_tools/manage.php?limit=<?php echo $this_limit ?>&m=<?php echo $config_mod ?>&f=<?php echo $this_name ?>&w=<?php echo $this_w ?>&h=<?php echo $this_h ?>&alt_text=<?php echo @${'get_alt_'.$this_name} ?>&alt_text_en=<?php echo @${'get_alt_en_'.$this_name} ?>&alt_text_sort=<?php echo @${'get_alt_sort_'.$this_name} ?>" width="100%" height="1" scrolling="no" frameborder="0"></iframe>