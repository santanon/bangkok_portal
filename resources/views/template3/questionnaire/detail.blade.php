    ...
    <div class="container">
        <div class="inner-content">
            <div class="main-content pt-0">
                                ...
                                <div class="item -question -inside">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="right px-0 pb-3 border-bottom-secondary" style="background-color: inherit;">                                          
                ...
                <div class="group-form-section mt-0">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="left bg-color-secondary active">
                                ...
                                <div class="text-onbottom bg-color-secondary">
                                    ผู้ตอบคำถาม <span>155 คน</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="top-content -question">   
                    ...
                    <div class="topic-form">
                        <div class="order-topic">
                            <div class="title-article color-secondary">ท่านอายุเท่าไร</div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="list-choice">
                                        <div class="input-custom d-flex m-0">
                        ...
                        <div class="order-topic">
                            <div class="title-article color-secondary">ระยะเวลาในการเข้าใช้งานห้องสมุด</div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="list-choice">
                                        <div class="input-custom d-flex m-0">
                        ...
                        <div class="order-topic">
                            <div class="title-article color-secondary">ท่านทราบข้อมูลห้องสนุดจากที่ไหน</div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="list-choice">
                                        <div class="input-custom d-flex m-0">
                        ...
                        <div class="order-topic">
                            <div class="title-article color-secondary">ท่านใช้อุปกรณ์ใดในการเข้าเว็บไซต์</div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="input-custom m-0">
                            ...
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
                                <g>
                                    <path class="st0" d="M3.9,4.5C3.4,5,3.4,5.8,3.9,6.3L9.6,12l-5.7,5.7l0,0c-0.5,0.5-0.5,1.4,0,1.9l0,0c0.5,0.5,1.4,0.5,1.9,0
                                        l6.6-6.6l0,0c0.5-0.5,0.5-1.4,0-1.9L5.7,4.5l0,0C5.2,4,4.4,4,3.9,4.5L3.9,4.5z"></path>
                                    <path class="st0" d="M11.6,4.5c-0.5,0.5-0.5,1.3,0,1.8l5.7,5.7l-5.7,5.7l0,0c-0.5,0.5-0.5,1.4,0,1.9l0,0c0.5,0.5,1.4,0.5,1.9,0
                                        l6.6-6.6l0,0c0.5-0.5,0.5-1.4,0-1.9l-6.7-6.6l0,0C12.9,4,12.1,4,11.6,4.5L11.6,4.5z"></path>
                                </g>
                            </svg>
                        </div>
                        ย้อนกลับ
