...
<script type="text/javascript" rel="preload" src="{{ asset('template4/js/init.js') }}"></script>
...
<!-- navgoco -->
<link rel="stylesheet" href="{{ asset('template4/css/jquery.navgoco.css')}}">
<script type="text/javascript" src="{{ asset('template4/js/jquery.navgoco.min.js') }}"></script>

<!-- DragDrop -->
<script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script> 

<!-- Slick -->
<link rel="stylesheet" href="{{ asset('template4/css/slick.css')}}">
<link rel="stylesheet" href="{{ asset('template4/css/slick-theme.css')}}">
