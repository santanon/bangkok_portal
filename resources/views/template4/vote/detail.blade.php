            ...
            <div class="row">
                <div class="col-12">
                    <div class="main-content border-bottom">
                        <!-- <div class="top-content detail-page" style="margin-top: 50px">
                            <div class="group-text">
                                <h3 class="title">กรุงเทพฯ เป็นเมืองน่าท่องเที่ยวที่สุดในโลก และเป็นเมืองจุดหมายปลายทางที่ได้รับความนิยมมากที่สุดในโลก</h3>
                            </div>
                        </div> -->
                        ...
                        <div class="vote-template">
                            <div class="group-vote detail-page">
                                ...
                                <div class="top-content detail-page">
                                    <div class="group-text">
                                        <h3 class="title">ผลโหวต</h3>
                                    </div>
                                </div>
