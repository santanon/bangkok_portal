  ...
  <tr>
            ...
            <tr>
                ...
                <td> 
					...
					{
						?>
                        <option value="<?php echo str_replace('upload/user/'.sprintf('%08d', $_SESSION['panel_id']).'','',$a[1]) ?>" <?php if($edit_folder == str_replace('upload/user/'.sprintf('%08d', $_SESSION['panel_id']).'','',$a[1])){ ?> selected="selected" <? } ?>><?php echo str_replace('upload/user/'.sprintf('%08d', $_SESSION['panel_id']).'','',$a[1]) ?></option> 
                        <?php	
					} 
                    ?> 
                    </select>
