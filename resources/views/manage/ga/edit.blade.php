...
<script>
	parent.document.getElementById('modal_full_span').innerHTML = 'Google Analytics';
	</script>
...
function show_link(v1)
{
    ...
    <form method="post" enctype="multipart/form-data" onsubmit="return check_form();" action="http://127.0.0.1:8000/manage-admin/edit_ga_submit?m=<?php echo $config_mod;  ?>">
    @csrf <!-- {{ csrf_field() }} -->
    <table>
        <tbody>
            <tr>
