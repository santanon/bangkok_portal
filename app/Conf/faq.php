...
/*
URL PATH : /panels/faq/
LOCATION : /application/controllers/panels/faq.php
*/
 
class Faq
{  
	var $mod = 'faq'; 
	var $mod_model = 'Portal_website_faq_model'; 
	var $mod_title = 'FAQ'; 
	
	var $mod_cat_mod = 'faq_cat'; 
	var $mod_cat_model = 'Portal_website_faq_cat_model'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,15,2); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,15,3); btn2stageFocus(0,2);';  
	...
	{ 
		...
		{  
			...
			$data['config_footer_js'] = 'mainmenuFocus(1,15,2); btn2stageFocus(0,1);';  
			$data['config_dropdown_title'] = $this->lang->line($this->mod_cat_dropdown_title); 
