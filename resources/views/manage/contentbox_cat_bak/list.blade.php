...
{   
    ...
    <td align="left"> &nbsp; <span class="link-text"><a href="<?php echo base_url() ?>panels/contentbox/set_cat/<?php echo $row->id ?>"> <?php echo $row->title ?> </a></span> [ <?php echo $list_sub_count[$row->id] ?> ]</td>
