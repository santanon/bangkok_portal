...
{  
	var $mod = 'news_cat'; 
	var $mod_model = 'Portal_website_news_cat_model'; 
	var $mod_title = 'News Group'; 
	var $mod_cat_field = ''; 
	var $config_search_field = array('title'); 
	
	var $mod_sub_model = 'Portal_website_news_model'; 
	var $mod_sub_field = 'cat_id'; 
	var $mod_sub_mod = 'news'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,9,1); btn2stageFocus(0,1);';
