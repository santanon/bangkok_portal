<tr>
 ...
 <tr id="link_hide_a">
    ...
    <input name="date_start" id="date_start" type="text" class="sm-input" style="width:150px" readonly="readonly" value="<?php if($edit_date_start > 0){echo date('d-m-Y',$edit_date_start);} ?>"> 
    </div>
    </td>
</tr> 
<tr id="link_hide_b">
    ...
    <input name="date_end" id="date_end" type="text" class="sm-input" style="width:150px" readonly="readonly" value="<?php if($edit_date_end > 0){echo date('d-m-Y',$edit_date_end);} ?>"> 
    </div>
    </td>
</tr> 
