...
/*
URL PATH : /panels/activities/
LOCATION : /application/controllers/panels/activities.php
*/
...
{  
	...
	{ 
		...
		if(strlen($this->input->post('date_news_end', TRUE)) > 3)
		{
			$arr = explode('-',$this->input->post('date_news_end', TRUE));
			$start_d = $arr[0];
			$start_m = $arr[1];
			$start_y = $arr[2];	
