...
/*
URL PATH : /panels/banner/
LOCATION : /application/controllers/panels/banner.php
*/
...
{  
	var $mod = 'banner'; 
	var $mod_model = 'Portal_website_banner_model'; 
	var $mod_title = 'Banner'; 
	
	var $mod_cat_mod = 'banner_cat'; 
	var $mod_cat_model = 'Portal_website_banner_cat_model'; 
	...
	var $config_list_footer_js = 'mainmenuFocus(1,7,2); btn2stageFocus(0,1);';
	...
	{ 
		...
		$data['config_footer_js'] = 'mainmenuFocus(1,7,3); btn2stageFocus(0,2);';      
