					...
					<div id="page1col">
						<div id="content-slide-container">
							...
							<div class="content-slide-box expanded" style="width:100%">
                                ...
                                <div align="center"><br />
                                <span class="btn round big blue"><input type="button" class="fontfacetext" value="<?php echo $TextLanguage->lang('reply') ?>" onclick="window.top.location = 'http://127.0.0.1:8000/manage-admin/send?m=<?php echo $config_mod; ?>&id=<?php echo $read_id ?>';"></span>
