...
<head>
	...
	<title><?php echo $TextLanguage->lang('title_reset_password'); ?></title>
                        ...
                        <div class="content-slide-box expanded">
                            <div class="content-slide-trigger">
                                ...
                                <a href="#" class="trigger-text fontfacetext">
                                    <span><?php echo $TextLanguage->lang('reset_password'); ?></span>
                                </a>
                                    ...
                                    <form method="post" action="<?php echo base_url(); ?>panel/reset_password_save" onSubmit="return check_email()">
                                        <table>
                                            <tr>
                                                ...
                                                <td><div class="input-round-big"><input id="p" name="p" type="password"></div></td>
                                            </tr> 
                                             <tr>
                                                <td align="right"><label for="uId" class="fontfacetext-bold"><?php echo $TextLanguage->lang('confirm_new_password'); ?></label></td>
                                                <td><div class="input-round-big"><input id="rp" name="rp" type="password"></div></td>
                                            </tr> 
                                            <tr>
                                                <td>&nbsp;</td>
